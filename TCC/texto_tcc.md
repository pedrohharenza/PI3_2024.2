...
Para o controle da comutação de energia, foram selecionados dois relés, um para a fase e outro para o neutro. Os relés utilizados são do modelo HF161F da Hongfa, que possuem capacidade para suportar até 20A em 250VAC e corrente de acionamento de 75mA, atendendo assim a todos os requisitos necessários para a aplicação. A escolha de utilizar relés em uma estação de recarga monofásica é justificada principalmente pelo custo e tamanho reduzido, quando comparado à utilização de contactores, além de apresentar alta disponibilidade, são compactos e atendem as necessidades da aplicação.
