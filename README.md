...
## Etapas do Projeto
1. **Etapa 1**: Definir os parâmetros de funcionamento da estação de recarga e apresentar uma simulação simplificada para validação dos circuitos da estação de recarga.
