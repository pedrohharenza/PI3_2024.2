...
## Etapas do Projeto
1. [**Etapa 1**](Etapa%201/Definição%20dos%20parâmetros%20de%20funcionamento): Definição dos parâmetros de funcionamento da estação de recarga e apresentar uma simulação simplificada para validação dos circuitos que serão utilizados.
