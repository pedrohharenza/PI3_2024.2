...
## Etapas do Projeto
1. [**Etapa 1**](Etapa 1/Definição dos Parâmetros de Funcionamento.md): Definição dos parâmetros de funcionamento da estação de recarga e apresentar uma simulação simplificada para validação dos circuitos que serão utilizados.
